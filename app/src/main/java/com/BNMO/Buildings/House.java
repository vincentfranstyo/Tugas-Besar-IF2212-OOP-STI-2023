    ...
    public void addRoom(Room curRoom){
        ...
        public void run(){
            try {
                ...
                if(curRoom.getFront() != null && curRoom.getRight() != null && curRoom.getBehind() != null && curRoom.getLeft() != null){
                    ...
                    if(curRoom.getFront() == null) System.out.println("Front");
                    if(curRoom.getRight() == null) System.out.println("Right");
                    if(curRoom.getBehind() == null) System.out.println("Behind");
                    if(curRoom.getLeft() == null) System.out.println("Left");                
