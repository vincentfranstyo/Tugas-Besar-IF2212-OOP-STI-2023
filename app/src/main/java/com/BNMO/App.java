                ...
                if (commandNum == 1) {
                    ...
                    if(numUpHouse == 1){
                        ...
                        if(menu.getCurrentSim().getCurrentRoom().getFront() != null && menu.getCurrentSim().getCurrentRoom().getRight() != null && menu.getCurrentSim().getCurrentRoom().getBehind() != null && menu.getCurrentSim().getCurrentRoom().getLeft() != null){
                            ...
                            System.out.println();
                            menu.getCurrentSim().getCurrentHouse().addRoom(menu.getCurrentSim(), menu.getCurrentSim().getCurrentRoom(), roomName, choice);
                        }
                    }
                        ...
                        if(objAdd != null){
                            ...
                            System.out.print("Masukkan Lokasi Object Pada Ruangan 6x6:");
